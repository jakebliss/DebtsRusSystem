...
public class Account {
   ...
   public static boolean checkTransaction(String originAccount, String totalAmount) {
	   // TODO: Submit a check transaction for an account.
	   return true;
   }
   
   public static String[] listClosedAccounts() {
	   // TODO: Generate a list of all accounts which have closed in the last month.
	   return null;
   }
   
   public static String[] getCustomerReport(String customerId) {
	   // TODO: Generate a list of all accounts associated with a particular customer and indicate whether the accounts are open or closed.
	   return null;
   }
}
